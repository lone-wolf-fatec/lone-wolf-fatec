...
## 💻 Projetos
| Semestre | Projeto | Organização | Cliente | Descrição |
|:--------:|:-------:|:-----------:|:-------:|:---------:|
| 3º | [CuidaEmprego](https://github.com/lone-wolf-fatec/CuidaEmprego) | FATEC | Gerson da Penha Neto | Aplicação web de batimento de ponto e tudo relacionado ao dia a dia do colaborador e do administrador de emprego. |
## 🚀 Habilidades
